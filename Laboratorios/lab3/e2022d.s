...
reset:
  ...
  // Configura los pines de los display como gpio sin pull-up
    ...
    MOV R8,#3 // CONTADOR PARA 3 SEGUNDOS TECLA CANCELAR
...
///// Modificaciones
    CMP R8,#0
    BEQ detener3segundos     //detiene el conteo Y vuelve a cero el contador
...
detener:
    ...
    BX    LR
/****************************************************************************/
/* Rutina detener y poner en cero el contador                                                         */
/* Esta rutina  pone un cero en la bandera para indicar que se detenga      */
/****************************************************************************/
detener3segundos:
    PUSH  {R0,R1}
    ...
    LDR R0,=contador
    MOV R1,#0      // coloco en cero el contador, valor inicial
    STRH R1,[R0]                        
    POP   {R0,R1}
    BX    LR
 /*****************************************************************************/
